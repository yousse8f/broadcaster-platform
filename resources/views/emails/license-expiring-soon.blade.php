...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #f8f9fa; padding: 30px; border-radius: 8px;">
            <h1 style="color: #dc3545; margin-bottom: 20px;">⚠️ Your License Will Expire Soon</h1>
            
            <p>Dear {{ $license->user->name }},</p>
            
            <p>This is a reminder that your license <strong>{{ $license->license_key }}</strong> will expire in <strong>{{ $daysUntilExpiration }} day(s)</strong>.</p>
            ...
            <p style="margin-top: 20px;">To avoid service interruption, please renew your license before the expiration date.</p>
            
            <div style="margin-top: 30px; padding: 20px; background: #fff; border-left: 4px solid #dc3545; border-radius: 4px;">
                <p style="margin: 0;"><strong>Action Required:</strong> Contact your administrator to renew your license.</p>
            </div>
